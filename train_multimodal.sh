...
python training/training_multimodal_vM1.py ../../../Data/sorted_sums_matched_w_struc_train.csv ../../../Data/struc_data.svmlight ../../../Data/vocab.csv mmnet 2 $len_train_final $len_val_final $len_test_final --train-frac 0.01 --test-frac 0.01 --post-conv-fc-bool True --post-merge-layer-size-list 4 --embed-dropout-bool True --embed-dropout-p 0.3 --batch-size 32 --kernel-sizes 3,5 --num-filter-maps 100 --fc-dropout-p 0.5 --embed-file ../../../Data/processed_full.embed --struc-layer-size-list 256,32 --struc-activation relu --struc-dropout-list 0.3
